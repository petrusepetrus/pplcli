                        ...
                        <div class="space-y-8 divide-y divide-gray-200">
                            ...
                            <div class="pt-8">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">We'll always let you know about important
                                        changes, but
                                        you
                            ...
                            <div class="pt-8">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Add your photo to make your profile more personal
                                    </p>
                                </div>
              ...
              <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                <svg class="h-full w-full text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z"/>
                                    ...
                                    <div class="sm:col-span-6">
                                        <label for="cover-photo" class="block text-sm font-medium text-gray-700"> Cover
                                            photo </label>
