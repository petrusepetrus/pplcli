            ...
            <div>
                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                    <div v-for="link in links" :key="link">
                        <a v-if="link.label.search('Previous')!==-1" v-on:click="handleClick('prev')" href="#"
                        ...
                        <a v-else-if="link.label.search('Next')!==-1" v-on:click="handleClick('next')" href="#"
                        ...
                        <a v-else v-on:click="handleClick(link.label)" href="#"
